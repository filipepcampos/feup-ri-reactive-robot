...
: ${AMENT_CURRENT_PREFIX:="/ws/src/install/my_reactive_robot_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_reactive_robot_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_reactive_robot_gazebo/environment/path.sh"
