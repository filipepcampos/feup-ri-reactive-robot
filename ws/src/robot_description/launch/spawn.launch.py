...
def launch_setup(context, *args, **kwargs):
    ...
    robot_desc_path = os.path.join(
        get_package_share_directory(package_description), "robot", xacro_file
    )
        ...
        parameters=[
            {
                ...
                "robot_description": Command(
                    ["xacro ", robot_desc_path, " robot_name:=", entity_name]
                ),
            }
        ],
        output="screen",
...
def generate_launch_description():
    ...
    entity_name_arg = DeclareLaunchArgument("entity_name", default_value="reactive_robot_1")
